/* =========================================================
   Печенька дня — логика
   ---------------------------------------------------------
   Всё, что нужно поменять под себя, лежит в CONFIG ниже.
   ========================================================= */
...
/* ---------------------------------------------------------
   ...
   Все голоса идут в общую шину: мягкий срез верхов + лимитер,
   плюс подмешивается короткий реверб. Из-за него звуки не
   «тыкают» в ухо, а мягко растворяются.
   --------------------------------------------------------- */
const Sfx = {
  ctx: null,
